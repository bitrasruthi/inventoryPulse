...
export function save(body: Types.PropertyRequestDto, config?: AxiosRequestConfig | undefined): Promise<Types.Anonymous4> {
...
function processSave(response: AxiosResponse): Promise<Types.Anonymous4> {
