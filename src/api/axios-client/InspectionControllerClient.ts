...
export function save(body: Types.InspectionRequestDto, config?: AxiosRequestConfig | undefined): Promise<Types.Anonymous2> {
...
function processSave(response: AxiosResponse): Promise<Types.Anonymous2> {
